...
| D-063 | Extension question system has two groups: operational questions (static behavior) and profile/topic questions (dynamic, file-driven). | Accepted | Group B must be loaded from questionnaire definition files, not hardcoded. |
