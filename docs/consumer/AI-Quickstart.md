...
## Prompt 4: Safe Edit Request
"Apply the requested change while respecting managed/override boundaries and non-destructive update rules defined by onboarding files."

## Prompt 5: PR Readiness Check
"Generate a pre-PR checklist based on onboarding constraints and identify unresolved risks."

## Usage Tip
Ask the model to cite which onboarding files informed each major decision.
