...
## Next Steps
- add CI workflow gates to enforce test and coverage thresholds on every pull request
- add scenario-matrix smoke tests that exercise real filesystem install/remove/repair sequences end-to-end
